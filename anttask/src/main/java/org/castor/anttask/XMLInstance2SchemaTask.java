...
public final class XMLInstance2SchemaTask extends MatchingTask {
    ...
    private void processFile(
        ...
        try {
            ...
            throw new BuildException(
                "Problem writing to the given putput sink " + filePath,
                e
            );
        } catch (SAXException e) {
            throw new BuildException(
                "Problem streaming the generated XML schema instance " +
                    "to the given file.",
                e
            );
        }
    ...
    public void execute() {
        ...
        if (
            _xmlInstanceFile == null &&
            _xmlInstanceDir == null &&
        ...
        if (
            _xmlInstanceDir != null &&
            _xmlInstanceDir.exists() &&
            _xmlInstanceDir.isDirectory()
        ) {
            ...
            for (String file : files) {
                String filePath =
                    _xmlInstanceDir.getAbsolutePath() + File.separator + file;
        ...
        for (FileSet xmlInstanceFileSet : _xmlInstanceFileSets) {
            ...
            for (String file : files) {
                String filePath =
                    subdir.getAbsolutePath() + File.separator + file;
                processFile(filePath, null);
            }
        }
    }
