 ...
 *
 */
public class SchemaUnmarshallerTest {
     ...
     * @throws FileNotFoundException
     */
    public void testUnmarshallSolrjSchema()
        throws FileNotFoundException, SAXException, IOException {
     ...
     */
    private Schema unmarshalSchema(final String schemaName)
        throws SAXException, IOException {
        Parser parser = null;
        ...
        parser.parse(
            new InputSource(getClass().getResource(schemaName).toExternalForm())
        );
